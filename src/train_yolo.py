...
results = model.train(data=f"datasets/{DATASET_NAME}/dataset.yaml", epochs=NUM_EPOCHS, imgsz=512, name=run_name, device=[1], batch=0.8, resume=False, fliplr=0.0, perspective=0.01, shear=0.2)
